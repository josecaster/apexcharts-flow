package sr.we.demo.athenticationauthorization;
...
import sr.we.data.service.SamplePersonService;
import sr.we.ui.components.TempDatePicker;
import sr.we.ui.views.MainLayout;

@PageTitle("Athentication & Authorization")
@Route(value = "auth/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
@Uses(Icon.class)
public class AthenticationAuthorizationView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "auth/%s/edit";
...
//    private CollaborationBinder<SamplePerson> binder;
    ...
    @Autowired
    public AthenticationAuthorizationView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("athentication-authorization-view");
...
//                binder.writeBean(this.samplePerson);
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AthenticationAuthorizationView.class);
            }
        }
    }
    ...
    private void createEditorLayout(SplitLayout splitLayout) {
        ...
        dateOfBirth = new TempDatePicker("Date Of Birth");
