...
@BreadCrumb(titleKey = "sr.we.products.services.edit",parentNavigationTarget = ServiceView.class)
@Route(value = "edit-service", layout = MainLayout.class)
@RolesAllowed({Role.user, Role.staff, Role.owner, Role.admin})
public class EditServiceView extends AddService implements BeforeEnterObserver {
    ...
    public static String getLocation(String business) {
        return MainLayout.getLocation(business) + "/edit-service";
    }
